...
pub const RACES: PerElement<RaceAttrs> = PerElement([
    ...
    RaceAttrs {
        ...
        bite: 800,
        digest: 650,
        repro_threshold: 1800,
        repro_cost: 1100,
        starve_dmg: 3,
        fantasy: "BUILDER. Roots where Water passes, enriches its ground by existing, breeds on a steady trickle — and its groves are what Fire comes to burn.",
    },
    // ---------------------------------------------------------------- FIRE
    RaceAttrs {
        ...
        repro_cost: 800,
        starve_dmg: 6,
        fantasy: "AGGRESSOR. Fast, wasteful, huge bite: it raids Wood's groves, strips them bare, breeds mid-raid, dies young — and its corpses are Earth's harvest.",
    },
    // --------------------------------------------------------------- EARTH
    RaceAttrs {
        ...
        bite: 1600,
        digest: 650,
        repro_threshold: 2600,
        repro_cost: 1700,
        starve_dmg: 3,
        fantasy: "BUILDER. Barely moves, harvests where Fire burned, presses its massif into the ground by existing — and Metal prospects what it accretes.",
    },
    // --------------------------------------------------------------- METAL
    RaceAttrs {
        ...
        bite: 2600,
        digest: 550,
        repro_threshold: 6000,
        repro_cost: 1400,
        starve_dmg: 2,
        fantasy: "NOMAD. Endures famine, gorges when it strikes an Earth massif, breeds only on a trove — and the veins it forges are Water's food.",
    },
    // --------------------------------------------------------------- WATER
    RaceAttrs {
        ...
        speed: Fx::ratio(38, 100),
        radius: Fx::ratio(50, 100),
        deposit_unit: 8_900,
        deposit: RateBand::new(9000, 12_000, 26_000, 10),
        // Erodes what it moves across. Action-dominant: standing still, Water
        // does almost nothing.
        deposit_mix: ChannelMix::new(25, 175, 650, 125, 25),
        consume_unit: 12_000,
        ...
        bite: 2400,
        digest: 550,
        repro_threshold: 5200,
        repro_cost: 1300,
        starve_dmg: 2,
        fantasy: "NOMAD. Flows far, breeds only on a rich Metal vein, and the trail it wears into the ground is what Wood roots in.",
    },
]);
