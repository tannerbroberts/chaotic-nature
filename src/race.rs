...
pub const RACES: PerElement<RaceAttrs> = PerElement([
    ...
    RaceAttrs {
        ...
        deposit_unit: 38_000,
        deposit: RateBand::new(4000, 5000, 9000, 6),
    ...
    RaceAttrs {
        ...
        deposit: RateBand::new(1600, 2500, 10_000, 20),
    ...
    RaceAttrs {
        ...
        deposit: RateBand::new(6400, 7000, 9000, 2),
    ...
    RaceAttrs {
        ...
        deposit: RateBand::new(2000, 3000, 8000, 12),
    ...
    RaceAttrs {
        ...
        deposit_unit: 8_900,
        deposit: RateBand::new(2400, 3500, 8500, 10),
